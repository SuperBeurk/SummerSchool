...
void Menu_endGame(GameParameters* g)
{
    ...
    if(g->s1.homeScore==0)
    {
        LCD_DrawText("PLAYER 2 WIN",&arialNarrow_12ptFontInfo,A_CENTER,50,50,0b1111111111111111,0b0000000000000000);
    }
    else
    {
        LCD_DrawText("PLAYER 1 WIN",&arialNarrow_12ptFontInfo,A_CENTER,50,50,0b1111111111111111,0b0000000000000000);
    }
