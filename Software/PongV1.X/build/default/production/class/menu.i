...
# 1 "class/../class/gameParameters.h" 1



# 1 "class/../libraries/lcd_highlevel.h" 1
# 4 "class/../class/gameParameters.h" 2
...
# 7 "class/../class/gameParameters.h" 2
...
# 8 "class/../class/gameParameters.h" 2
...
void Menu_endGame(GameParameters* g)
{
    ...
    if(g->s1.homeScore==0)
    {
        LCD_DrawText("PLAYER 2 WIN",&arialNarrow_12ptFontInfo,A_CENTER,100,50,0b1111111111111111,0b0000000000000000);
    }
    else
    {
        LCD_DrawText("PLAYER 1 WIN",&arialNarrow_12ptFontInfo,A_CENTER,100,50,0b1111111111111111,0b0000000000000000);
    }
