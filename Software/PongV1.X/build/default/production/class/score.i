...
void Score_draw(struct Score* s)
{
    ...
    LCD_DrawText(s->str,&arialNarrow_12ptFontInfo,A_LEFT,20,170,0b1111111111111111,0b0000000000000000);
    sprintf(s->str,"%d",s->awayScore);
    LCD_DrawText(s->str,&arialNarrow_12ptFontInfo,A_LEFT,20,138,0b1111111111111111,0b0000000000000000);
}
